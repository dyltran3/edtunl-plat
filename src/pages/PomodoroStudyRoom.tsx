...
const PomodoroStudyRoom: React.FC = () => {
  return (
        ...
        <main className="flex-1 relative flex flex-col gap-4 min-w-0">
          <div className="flex-1 glass whiteboard-grid rounded-2xl relative overflow-hidden shadow-2xl flex flex-col">
            <div className="absolute top-4 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 z-30">
              <div className="glass px-6 py-4 rounded-[2rem] shadow-2xl border border-white/50 flex flex-col items-center gap-3 min-w-[240px]">
                <div className="relative flex items-center justify-center w-24 h-24">
                  <svg className="absolute w-full h-full -rotate-90">
                    <circle className="text-white/20" cx="48" cy="48" fill="transparent" r="45" stroke="currentColor" strokeWidth="3"></circle>
                    <circle className="text-primary-purple timer-ring drop-shadow-[0_0_8px_rgba(127,19,236,0.6)]" cx="48" cy="48" fill="transparent" r="45" stroke="currentColor" strokeDasharray="283" strokeDashoffset="80" strokeWidth="3"></circle>
                  </svg>
                  <span className="text-2xl font-bold tracking-tight">25:00</span>
                </div>
                <div className="flex gap-1.5">
                  <button className="px-3 py-1 text-[9px] font-bold rounded-full bg-pastel-lavender text-primary-purple shadow-sm hover:scale-105 transition-transform">Focus</button>
                  <button className="px-3 py-1 text-[9px] font-bold rounded-full bg-pastel-mint text-emerald-700 shadow-sm hover:scale-105 transition-transform">Short Break</button>
                  <button className="px-3 py-1 text-[9px] font-bold rounded-full bg-pastel-blue text-blue-700 shadow-sm hover:scale-105 transition-transform">Long Break</button>
                </div>
                <div className="flex items-center gap-3 mt-1">
                  <button className="w-8 h-8 rounded-full bg-primary-purple text-white flex items-center justify-center shadow-lg shadow-primary-purple/30">
                    <span className="material-symbols-outlined text-lg">play_arrow</span>
                  </button>
                  <button className="w-8 h-8 rounded-full bg-white/50 flex items-center justify-center text-gray-600">
                    <span className="material-symbols-outlined text-lg">replay</span>
                  </button>
                </div>
              </div>
              <div className="glass px-4 py-2 rounded-2xl flex items-center gap-4 shadow-xl border border-white/50">
            ...
            <div className="flex-1 relative overflow-hidden p-20">
              <div className="absolute top-64 left-40 w-40 h-40 bg-pastel-yellow shadow-lg rotate-[-2deg] p-4 flex flex-col justify-between rounded-sm">
              ...
              <div className="absolute top-56 right-48 w-44 h-44 bg-pastel-pink shadow-lg rotate-[3deg] p-4 flex flex-col justify-between rounded-sm">
...
export default PomodoroStudyRoom;
