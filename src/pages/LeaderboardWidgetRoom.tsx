...
const LeaderboardWidgetRoom: React.FC = () => {
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-[#141118] dark:text-white transition-colors duration-300 min-h-screen">
      ...
      <div className="flex h-screen w-full p-4 gap-4 overflow-hidden relative">
        <aside className="w-60 flex flex-col gap-4 shrink-0 relative">
          <div className="glass p-4 rounded-xl shadow-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="bg-primary-purple/20 p-2 rounded-lg">
                  <span className="material-symbols-outlined text-primary-purple text-lg">auto_stories</span>
                </div>
                <div>
              ...
              <button className="w-6 h-6 flex items-center justify-center hover:bg-white/40 rounded-full transition-colors" title="Toggle Leaderboard">
                <span className="material-symbols-outlined text-sm text-primary-purple">leaderboard</span>
              </button>
            </div>
          </div>
          <div className="glass p-3 rounded-xl shadow-lg border border-white/40 flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <span className="material-symbols-outlined text-xs text-primary-purple">military_tech</span>
                <h3 className="text-[10px] font-bold uppercase tracking-wider">Session Leaders</h3>
              </div>
              <div className="flex items-center gap-1">
                <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full pulse-live"></div>
                <span className="text-[8px] font-bold text-gray-400">LIVE</span>
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between bg-white/30 dark:bg-white/5 p-1.5 rounded-lg border border-white/20">
                <div className="flex items-center gap-2">
                  <div className="relative">
                    <img alt="User Avatar" className="w-6 h-6 rounded-full object-cover border border-white shadow-sm" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDUK_wuCXSjQmneMra96U34QcLtApPb5QZ6ZH9PWMkZSDhi3l6eMxkMH55hnpfBI30CFl234mgEXR-cMPszuk9jEIW4QKbigpEcoxJAIhcNV7sA0MCorbbwcNvHM5WNOzss89DVF64Jvg2BrjrhuefWJ1iUhepLq9iibx0JIDCTUDmrlL2E0O_asU7P6vHwFfcXpu7krsoPsQhbBa2ZJc7Zge5pcTBxXOj45Rh7USxl7XofP56v4lkjdstF-R7ioXYErtu2qRBYzbA"/>
                    <span className="material-symbols-outlined absolute -top-1 -right-1 text-[10px] text-yellow-500 bg-white rounded-full leading-none p-0.5" style={{fontVariationSettings: "'FILL' 1"}}>crown</span>
                  </div>
                  <span className="text-[10px] font-bold truncate w-16">You</span>
                </div>
                <span className="text-[9px] font-bold text-primary-purple">45m</span>
              </div>
              <div className="flex items-center justify-between p-1.5">
                <div className="flex items-center gap-2">
                  <img alt="Jordan" className="w-6 h-6 rounded-full object-cover grayscale-[0.5]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD7L6jdtfD3tVCBlwsdCXu7qFw3XnCIpsg6Fby_9tEp8QjExdVpDcwOYxisCBwJSiYG8NqnfGjpDnTpz0lSVmjBGdw49k1f9musDfZN9w0pHomvBDeOuPxU80m2K5yXCHcWIlRCcpSByLXIk63HoUZi8-30EWuVxDB6W4NyzGgT-Q4b9ZI1hSRmmI_ycg1bPMjOV85GnxzFAunF62co_UNaFsOlQ6vzgL8U3SZrtcWLAUKqqOhFc3fwqqxSKyHOI_M7p_jG1sx-EI4"/>
                  <span className="text-[10px] font-medium text-gray-600 dark:text-gray-300">Jordan</span>
                </div>
                <span className="text-[9px] font-medium text-gray-500">38m</span>
              </div>
              <div className="flex items-center justify-between p-1.5">
                <div className="flex items-center gap-2">
                  <img alt="Riley" className="w-6 h-6 rounded-full object-cover grayscale-[0.5]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDf0CAdfxO18LhePk0PDOwt44GNucR2GMiJkKBlSrkHKywQ6YDX3A0HiEZDAZrP0tseazDjt2xGY-FmB7zDun-xGlFzl0O3P5r7m_lnVGNNy4jgNUc1xa-iAUr49NfQhE9TPtLpKmWlCNcVzHvFqvw4HYKg-gbJSV43MnCTfA5MFoeVm6cdXkqEQfzfPseScHtRWoHjqLz66IReJVtG5azoct61OSX085G3b0v3sio1qbwsIK1DnxaopKm46KZ9k2483wQk7_vnbWU"/>
                  <span className="text-[10px] font-medium text-gray-600 dark:text-gray-300">Riley</span>
                </div>
                <span className="text-[9px] font-medium text-gray-500">32m</span>
              </div>
            </div>
          </div>
...
export default LeaderboardWidgetRoom;
