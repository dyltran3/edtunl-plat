...
const PomodoroEnhancedRoom: React.FC = () => {
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-[#141118] dark:text-white transition-colors duration-300 min-h-screen">
      ...
      <div className="flex h-screen w-full p-4 gap-4 overflow-hidden relative">
        ...
        <aside className="w-64 flex flex-col gap-4 shrink-0">
          <div className="glass p-5 rounded-2xl shadow-xl border border-white/50 flex flex-col items-center gap-4">
            <div className="relative w-32 h-32 flex items-center justify-center">
              <svg className="w-full h-full pomodoro-progress" viewBox="0 0 100 100">
                <circle className="text-white/20" cx="50" cy="50" fill="transparent" r="45" stroke="currentColor" strokeWidth="6"></circle>
                <circle className="text-pastel-coral" cx="50" cy="50" fill="transparent" r="45" stroke="currentColor" strokeDasharray="282.7" strokeDashoffset="70" strokeLinecap="round" strokeWidth="6"></circle>
              </svg>
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <p className="text-2xl font-bold tracking-tight">25:00</p>
                <p className="text-[8px] font-bold text-pastel-coral uppercase tracking-[0.2em] -mt-1">Focus</p>
              </div>
            </div>
            <div className="flex items-center gap-6">
              ...
              <button className="w-10 h-10 rounded-full bg-pastel-coral flex items-center justify-center text-white shadow-lg shadow-pastel-coral/20 hover:scale-105 transition-transform">
          ...
          <div className="glass flex-1 rounded-xl flex flex-col overflow-hidden shadow-xl">
...
export default PomodoroEnhancedRoom;
